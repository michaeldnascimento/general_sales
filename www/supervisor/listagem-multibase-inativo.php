...
<form action="listagem-multibase-inativo.php" method="post">
    <div class="form-group">
...
<h2><center><strong>MULTIBASE</strong> <strong style="color:red">(INATIVO)</strong></center></h2>
