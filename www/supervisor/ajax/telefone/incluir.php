...
if (isset($_POST['nometelefone'])) {

    //Operadora
    $nome     = $_POST['nometelefone'];
    $operadora  = $_POST['telefoneoperadora'];
    ...
    $sql = "INSERT INTO telefonia (nome, status, operadora) VALUES ('$nome', 1, '$operadora')";
