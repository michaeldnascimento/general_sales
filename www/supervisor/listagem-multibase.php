...
$stringSql = "SELECT id_cliente, motivo_cliente, cidade_cliente, lista_sistema, nome_contato_cliente, cpf_cnpj_cliente, ddd_fone_cliente, fone_cliente, ddd_celular_cliente, celular_cliente, numHP_cliente, endereco_cliente , origemCSV, observacao_cliente, flag  FROM clientes WHERE lista_sistema = 'EXCLUSIVO' AND (status_mailing IS NULL OR status_mailing = 'ATIVO') ORDER BY id_cliente DESC";
...
<div id="main" class="container-fluid">
		...
		<div class="col-md-12">
        <a href="#" onclick="window.open('listagem-multibase-inativo.php', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=100, LEFT=200, WIDTH=400, HEIGHT=400');" class="btn btn-danger active btn-sm pull-left h2">INATIVOS</a>
...
<form action="listagem-multibase.php" method="post">
    <div class="form-group">
...
<h2><center><strong>BASE</strong></center></h2>
...
<!--**********************************LISTAGEM******************************************** -->
<form action="status-listagem.php?lista=MULTIBASE" method="POST">
