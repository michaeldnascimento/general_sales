...
<div class="btn-group">
 ...
 <br/>
      ...
      <label style="display: <?php echo $emp ?>" class="col-md-1 control-label" for="selectbasic">TV</label>
      <div class="col-md-5">
      <select style="display: <?php echo $emp ?>" id="tv_venda_cliente" name="tv_venda_cliente" class="form-control">
      <option value=""></option>
      ...
      <label style="display: <?php echo $emp ?>" class="col-md-1 control-label" for="selectbasic">Celular</label>
      <div class="col-md-5">
      <select style="display: <?php echo $emp ?>" id="netcelular_venda_cliente" name="netcelular_venda_cliente" class="form-control">
      <option value=""></option>
      ...
      <label style="display: <?php echo $emp ?>" class="col-sm-1 control-label" for="textinput">Port. Cel</label>
      <div class="col-sm-5">
      <div class="input-group">
      <input style="display: <?php echo $emp ?>" type="tel" pattern="[0-9]+$" title="Nao sao aceitos (ABC.,/@$+-\*) somente numeros!" placeholder="N. Portabilidade Celular" maxlength="15" class="form-control" name="portcelular_venda_cliente" id="portcelular_venda_cliente">
      <span style="display: <?php echo $emp ?>" class="input-group-addon label-white"><i class="glyphicon glyphicon-phone"></i></span>
      </div>
      </div>
      </div>
      ...
      <div class="col-md-5">
      <select id="plano_multi_cliente" name="plano_multi_cliente" class="form-control">
      <option value=""></option>
     ...
     <option value="25 GB + MIN ILIMITADOS">25 GB + MIN ILIMITADOS</option>
      ...
      <div class="col-md-1">
      <select id="qtdchip_multi_cliente" name="qtdchip_multi_cliente" class="form-control">
      <option value=""></option>
