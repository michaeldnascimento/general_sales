...
<h4><center><strong style="color: green">BASE TV</strong></center></h4>
<br/>
<!-- Split button -->
<div class="col-md-10">
<div class="btn-group">
...
<form action="nova-venda-salvar-base.php?&lista=BASETV" method="POST"  class="form-horizontal">
      ...
      <label class="col-md-1 control-label" for="selectbasic">Plano TV</label>
      <div class="col-md-5">
      <select id="tv_venda_cliente" name="tv_venda_cliente" class="form-control" required>
      <option value=""></option>
     <option value="FACIL DIGITAL">FACIL DIGITAL</option>
     <option value="ESSENCIAL DIGITAL">ESSENCIAL DIGITAL</option>
     ...
     <input type="text" style="display: none" name="lista_sistema" class="form-control input-md" id="lista_sistema" value="VENDA-BASETV">

    <input type="text" style="display: none" name="motivo_cliente" class="form-control input-md" id="motivo_cliente" value="VENDA - BASE TV">
