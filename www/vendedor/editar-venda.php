...
if ($statusvenda == 'INSTALADO' OR $statusvenda == 'CANCELADO' OR $statusvenda == 'AGENDADO' OR $statusvenda == 'REPROVADA' OR $statusvenda == 'QUEBRA') {
  ?>
...
<div id="main">
<form action="salvarvenda-editada.php?id=<?=$id;?>" method="POST" class="form-horizontal">
        ...
        <h4><center><strong style="color:green">Dados Cliente</strong></center></h4>
         ...
         <!-- Text input-->
          ...
          <div class="col-sm-3">
          <div class="input-group">
          <input type="text" maxlength="18" name="cpf_cnpj_cliente" required id="cpfCnpj" class="form-control" name="cpf_cnpj_cliente" value="<?=$cliente['cpf_cnpj_cliente']?>">
          <span class="input-group-addon label-white"><i class="glyphicon glyphicon-user"></i></span>
          </div>
          </div>
          ...
          <div class="col-sm-3">
          <div class="input-group">
          <input type="text" maxlength="16" name="rg_ie_cliente" id="rgEi" class="form-control" name="rg_ie_cliente" value="<?=$cliente['rg_ie_cliente']?>">
          <span class="input-group-addon label-white"><i class="glyphicon glyphicon-user"></i></span>
          </div>
          </div>
          ...
          <div class="col-sm-2">
          <div class="input-group">
          <input type="text" class="form-control"name="cep_cliente" id="campoCEP" type="text" placeholder="Digite o CEP..." required size="10" maxlength="9" onblur="pesquisacep(this.value);" value="<?=$cliente['cep_cliente']?>">
...
<br/>
          ...
          <div class="col-sm-2">
          <select id="select" name="formaPagemento_cliente" class="form-control" required>
         ...
         <select id="vencimentoPagamento_cliente" name="vencimentoPagamento_cliente" class="form-control">
          ...
          <div class="col-md-3">
          <input type="codigo" placeholder="Codigo do cliente" pattern="[0-9]+$" title="Nao sao aceitos (ABC.,/@$+-\*) somente numeros!" name="codigo_cliente" value="<?=$cliente['codigo_cliente']?>" class="form-control input-md" onblur="liberar();" autofocus>
          </div>
         ...
         <div class="form-group">
          ...
          <div class="col-md-3">
          <select id="statusPedido_venda_cliente" value="<?=$cliente['statusPedido_venda_cliente']?>" name="statusPedido_venda_cliente" class="form-control" required>
          ...
          <div class="col-md-2">
          <a href="consultar-minhavenda.php?id=<?=$cliente['id_cliente'];?>&lista=<?=$lista?>" class="btn btn-default">Voltar</a>
