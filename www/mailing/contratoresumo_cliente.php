...
<form action="contratosalvandoresumo_cliente.php?id=<?=$id;?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
...
<br />
          ...
          <hr />
<br />
          <h4><center><strong>Pedido</strong></center></h4>
<br />
...
<!--
          ...
          <div class="col-md-3">
          <label for="selectbasic">Anexar Audio:</label>
          <input type="file" id="audio_multisales" name="audio_multisales" required>
          </div>
