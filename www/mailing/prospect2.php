...
$ocorrencia = " SELECT id_cliente FROM clientes WHERE (lista_sistema = 'PROSPECT2') AND (motivo_cliente IS NULL OR motivo_cliente = '') AND (nomeUsuario IS NULL OR nomeUsuario = '') AND (status_mailing IS NULL OR status_mailing = 'ATIVO')";
...
//CONTADOR DO BOTÃO
$ocorrencia2 = " SELECT id_cliente FROM clientes WHERE (lista_sistema = 'PROSPECT2') AND (nomeUsuario = '{$nomeUsuario}') AND (motivo_cliente IS NULL OR motivo_cliente = '') AND (status_mailing IS NULL OR status_mailing = 'ATIVO')";
...
<div class="container">
         ...
         <!-- Text input-->
<form action="prospect2.php" method="post">
...
<div class="modal-body">
<div class="container">
      <form action="tabulapopup.php?lista=PROSPECT2" method="post">
...
<h2><strong>PROSPECT 2</strong></h2>
</div>
 ...
 <form action="geradormailing.php" method="post" onsubmit="this.enviar.value='Enviando...'; this.enviar.disabled=true;">
    ...
    <input type="text" style="display: none" name="lista" class="form-control input-md" id="lista" value="PROSPECT2">
