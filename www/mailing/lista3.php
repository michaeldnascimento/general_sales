...
if($empresa == '001' OR $empresa == '002' OR $empresa == '10' && ($acessoSL_login == 'SIM' OR $acessoTODOS == 'SIM')){
...
$ocorrencia = " SELECT id_cliente FROM clientes WHERE (lista_sistema = 'LISTA3') AND (motivo_cliente IS NULL OR motivo_cliente = '') AND (nomeUsuario IS NULL OR nomeUsuario = '') AND (status_mailing IS NULL OR status_mailing = 'ATIVO')";
...
//CONTADOR DO BOTÃO
$ocorrencia2 = " SELECT id_cliente FROM clientes WHERE (lista_sistema = 'LISTA3') AND (nomeUsuario = '{$nomeUsuario}') AND (motivo_cliente IS NULL OR motivo_cliente = '') AND (status_mailing IS NULL OR status_mailing = 'ATIVO')";
...
<div class="container">
         ...
         <!-- Text input-->
<form action="lista3.php" method="post">
...
<div class="modal-body">
<div class="container">
      <form action="tabulapopup.php?lista=LISTA3" method="post">
     ...
     <select required id="select" name="motivo_cliente" class="form-control">
      ...
      <option style="color:red" valeu="LIXEIRA - TELEFONE NAO ATENDE"> LIXEIRA - TELEFONE NAO ATENDE </option>
...
<h2><strong>LISTA3</strong></h2>
 ...
 <form action="geradormailing.php" method="post" onsubmit="this.enviar.value='Enviando...'; this.enviar.disabled=true;">
    ...
    <input type="text" style="display: none" name="lista" class="form-control input-md" id="lista" value="LISTA3">
