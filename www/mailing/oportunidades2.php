...
//***************EVENTOS DO BOTAO***************
    ...
    $ocorrencia = " SELECT id_cliente FROM clientes WHERE (lista_sistema = 'OPORTUNIDADES2') AND (motivo_cliente IS NULL OR motivo_cliente = '') AND (nomeUsuario IS NULL OR nomeUsuario = '') AND (status_mailing IS NULL OR status_mailing = 'ATIVO')";
...
//CONTADOR DO BOTÃO
    $ocorrencia2 = " SELECT id_cliente FROM clientes WHERE (lista_sistema = 'OPORTUNIDADES2') AND (nomeUsuario = '{$nomeUsuario}') AND (motivo_cliente IS NULL OR motivo_cliente = '') AND (status_mailing IS NULL OR status_mailing = 'ATIVO')";
    ...
    <div id="main" class="container-fluid">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container">
                            ...
                            <!-- Text input-->
                            <form action="oportunidades2.php" method="post">
        ...
        <div class="modal fade" id="delete-modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container">
                            <form action="tabulapopup.php?lista=OPORTUNIDADES2" method="post">
        ...
        <div class="page-header">
            <h2><strong>OPORTUNIDADES 2</strong></h2>
        </div>
        ...
        <form action="geradormailing.php" method="post" onsubmit="this.enviar.value='Enviando...'; this.enviar.disabled=true;">
            ...
            <input type="text" style="display: none" name="lista" class="form-control input-md" id="lista" value="OPORTUNIDADES2">
