...
if ($_POST['nomeUsuario'] !="" ) {
	...
	$stringSql = " SELECT id_cliente, cidade_cliente, flag, lista_sistema, nomeUsuario FROM clientes WHERE lista_sistema = '$lista' AND (origemCSV = 'SITE' OR origemCSV = 'LEAD') AND (motivo_cliente IS NULL OR motivo_cliente = '') AND (nomeUsuario IS NULL OR nomeUsuario = '') ORDER BY id_cliente DESC LIMIT 0, 1";
