            ...
            <form action="salvando-vendabackoffice.php?id=<?=$id;?>&lista=<?=$lista;?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-md-1 control-label" for="selectbasic">Obs. Venda</label>
                        <div class="col-sm-11">
                            <div class="input-group">
                                <?php
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-md-1 control-label" for="selectbasic">Agencia/Conta</label>
                        <div class="col-sm-1">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-2 control-label" for="textinput">Pre-Agendamento</label>
                        <div class="col-sm-3">
                            <div class="input-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            ...
                            <select id="motivo_cliente" name="motivo_cliente" class="form-control">
                                ...
                                <option style="color:green" value="VENDA - NOVO CLIENTE"> VENDA </option>
                                <option style="color:green" value="VENDA - UPGRADE"> VENDA - UPGRADE </option>
                                <option style="color:blue" value="RETORNO"> OPORTUNIDADE - RETORNO AGENDADO </option>
                                ...
                                <option style="color:red" value="LIXEIRA - NAO TEM COBERTURA"> LIXEIRA - NAO TEM COBERTURA </option>
                                ...
                                <option style="color:red" value="LIXEIRA - SENDO ATENDIDO POR OUTRO VENDEDOR"> LIXEIRA - ATENDIDO POR OUTRO VENDEDOR </option>
                        ...
                        <div id='mestre'>
                            ...
                            <div id='PENDENTE-VENDEDOR'>
                                ...
                                <select style="width: 200px; height: 30px;" id="motivoPendenciaVendedor_venda_cliente" name="motivoPendenciaVendedor_venda_cliente" class="col-md-3" >
                                    ...
                                    <option value="PROBLEMAS DE CREDITO">PROBLEMAS DE CREDITO</option>
                                    ...
                                    <option value="PROBLEMAS NO PRODUTO VENDIDO">PROBLEMAS NO PRODUTO VENDIDO</option>
                            ...
                            <div id='PENDENTE-BACKOFFICE'>
                                ...
                                <select style="width: 200px; height: 30px;" id="motivoPendencia_venda_cliente" name="motivoPendencia_venda_cliente" class="col-md-3" >
                                    ...
                                    <option value="EM ANALISE ALGAR">EM ANALISE ALGAR</option>
                                    <option value="OUTROS">OUTROS</option>
                                </select>
                            </div>
                            ...
                            <div id='CANCELADO'>
                                ...
                                <select style="width: 260px; height: 30px;" id="motivoCanc_venda_cliente" value="<?=$cliente['motivoCanc_venda_cliente']?>" name="motivoCanc_venda_cliente" class="col-md-3" >
                                    ...
                                    <option value="DUPLICIDADE DE PEDIDO">DUPLICIDADE DE PEDIDO</option>
                                    ...
                                    <option value="IMOVEL NAO CONTEMPLA PADRAO">IMOVEL NAO CONTEMPLA PADRAO</option>
                                    <option value="ERRO DE VENDA">ERRO DE VENDA</option>
                                    <option value="ERRO DE ENDERECO">ERRO DE ENDERECO</option>
                                    ...
                                    <option value="ENDERECO NAO LOCALIZADO">ENDERECO NAO LOCALIZADO</option>
                                    <option value="BACKBONE / ACIMA DO 4 ANDAR">BACKBONE / ACIMA DO 4 ANDAR</option>
                                    <option value="NAO TEM CABEAMENTO">NAO TEM CABEAMENTO</option>
                                    <option value="SEM PORTA / INFRAESTRUTURA">SEM PORTA / INFRAESTRUTURA</option>
                            ...
                            <div id='QUEBRA'>
                                ...
                                <select style="width: 200px; height: 30px;" id="motivoQuebra_venda_cliente" value="<?=$cliente['motivoQuebra_venda_cliente']?>" name="motivoQuebra_venda_cliente" class="col-md-4" >
                                    <option value="<?=$cliente['motivoQuebra_venda_cliente']?>"><?=$cliente['motivoQuebra_venda_cliente']?></option>
                                    <option value=""></option>
                                    <option value="Quebra de agenda equipe técnica">Quebra de agenda equipe técnica</option>
                                    <option value="Desistência do cliente">Desistência do cliente</option>
                                    <option value="Cliente ausente">Cliente ausente</option>
                                    <option value="Reagendamento solicitado pelo cliente">Reagendamento solicitado pelo cliente</option>
                                    <option value="Reagendamento solicitado pelo técnico">Reagendamento solicitado pelo técnico</option>
                                    <option value="Chuva">Chuva</option>
                                    <option value="Falta de material">Falta de material</option>
                                    <option value="Adequação de infra estrutura">Adequação de infra estrutura</option>
                                    <option value="Outros">Outros</option>
                                </select>
