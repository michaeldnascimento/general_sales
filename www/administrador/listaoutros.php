...
$stringSql = "SELECT id_login, situacao_login, login, senha, enviado, date_format(data_reset,'%d/%m/%y')as data_reset, date_format(data_caiu,'%d/%m/%y')as data_caiu FROM logins WHERE lista_login = 'OUTROS' ORDER BY id_login DESC";
...
$ativo = "SELECT id_login, situacao_login, login, senha, enviado, date_format(data_reset,'%d/%m/%y')as data_reset, date_format(data_caiu,'%d/%m/%y')as data_caiu FROM logins WHERE lista_login = 'OUTROS' AND situacao_login = 'HABILITADO' ORDER BY id_login DESC";
//echo $ocorrencia;
...
<div id="main" class="container-fluid">
	    ...
	    <div class="form-group">
            <div class="col-md-12">
             <a type="button" href="add-login.php?lista=OUTROS" class="btn btn-success active btn-xs pull-right" title="Inserir logins"><span class="glyphicon glyphicon-plus"></span></a>
...
<div class="form-group">
<h3><center><strong>LISTA OUTROS</strong></center></h3>
...
<!--****************************************CONTATOS*********************************** -->		 
		...
		<?php 
	 	...
	 	<tr>	
                ...
                <td class="actions">
				  <a class="btn btn-success btn-xs" title="Consultar Chamado" href="#" onclick="window.open('consultar-login.php?id=<?=$cliente['id'];?>&lista=OUTROS', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=110, LEFT=350, WIDTH=600, HEIGHT=500');"><span class="glyphicon glyphicon-pencil"></span></a>
