...
if($empresa == '003' && $nivel == 4 OR $nivel == 5){
...
$stringSql = "SELECT id_login, situacao_login, lista_login, login, senha, enviado, date_format(data_reset,'%d/%m/%y')as data_reset, date_format(data_caiu,'%d/%m/%y')as data_caiu FROM logins ORDER BY id_login DESC";
...
$ativo = "SELECT id_login, situacao_login, lista_login, login, senha, enviado, date_format(data_reset,'%d/%m/%y')as data_reset, date_format(data_caiu,'%d/%m/%y')as data_caiu FROM logins WHERE situacao_login = 'HABILITADO' ORDER BY id_login DESC";
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><strong>Logins</strong></h4>
      </div>
      <div class="modal-body">
		...
		<?php 
	 	...
	 	<tr>
                ...
                <td><strong>Tipo: </strong><?=$client['lista2'];?></td><br>
...
<div id="main" class="container-fluid">
	    ...
	    <div class="form-group">
            <div class="col-md-12">
             <a type="button" href="add-login.php?lista=logins" class="btn btn-success active btn-xs pull-right" title="Inserir logins"><span class="glyphicon glyphicon-plus"></span></a>
...
<div class="form-group">
<h3><center><strong>LISTA LOGINS</strong></center></h3>
...
<!--****************************************CONTATOS*********************************** -->		 
		...
		<?php 
	 	...
	 	<tr>	
                ...
                <td class="actions">
				  <a class="btn btn-success btn-xs" title="Consultar" href="#" onclick="window.open('consultar-login.php?id=<?=$cliente['id'];?>&lista=logins', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=110, LEFT=350, WIDTH=600, HEIGHT=500');"><span class="glyphicon glyphicon-pencil"></span></a>
